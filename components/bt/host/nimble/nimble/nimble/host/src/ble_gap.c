...
ble_gap_adv_enable_tx(int enable)
{
    ...
    cmd.enable = !!enable;
    BLE_HS_LOG(INFO, "GAP procedure initiated: Start advertising.\n");
    return ble_hs_hci_cmd_tx(BLE_HCI_OP(BLE_HCI_OGF_LE,
...
ble_gap_ext_adv_set_data_validate(uint8_t instance, struct os_mbuf *data)
{
    ...
    if (!ble_gap_slave[instance].configured) {
        printf("ble_gap_slave[0].configured = %d\n",ble_gap_slave[0].configured);
        printf("ble_gap_slave[1].configured = %d\n",ble_gap_slave[1].configured);
        printf("ble_gap_slave[2].configured = %d\n",ble_gap_slave[2].configured);
        printf("ble_gap_slave[3].configured = %d\n",ble_gap_slave[3].configured);
        printf("ble_gap_slave[4].configured = %d\n",ble_gap_slave[4].configured);
